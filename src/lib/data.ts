...
const reviews = [
    {
        ...
        comment:
            'Extremely disappointed. The product broke after just a few uses. Definitely not worth the price.',
    },
    {
        rating: 2,
        title: 'Not What I Expected',
        comment:
            'Felt cheaply made and didn’t fit right. Not something I’d consider buying again.',
    },
    {
        rating: 2,
        title: 'Could Be Better',
        comment:
            'Looks decent at first glance but doesn’t perform well. Needs serious improvements.',
    },
    {
        rating: 3,
        title: 'Average Experience',
        comment:
            'It’s alright. The quality is okay, but some aspects need refining.',
    },
    {
        rating: 3,
        title: 'Fair, But Lacking',
        comment:
            'It does the job, but not particularly well. The build quality feels a bit rushed.',
    },
    {
        rating: 3,
        title: 'Mixed Feelings',
        comment:
            'Some parts are great — like the material — but the overall product left me wanting more.',
    },
    {
        rating: 4,
        title: 'Great Value',
        comment:
            'Really good for the price. A few minor tweaks and it would be perfect.',
    },
    {
        rating: 4,
        title: 'Happy with It',
        comment:
            'Solid quality and performs well. I’d buy it again.',
    },
    {
        rating: 4,
        title: 'Love It!',
        comment:
            'Stylish and functional. Very happy with the purchase overall.',
    },
    {
        rating: 4,
        title: 'Better Than Expected',
        comment:
            'Well-made and reliable. Performs better than I thought it would.',
    },
    {
        rating: 5,
        title: 'Outstanding!',
        comment:
            'Absolutely perfect! Works exactly as advertised and feels high quality.',
    },
    {
        rating: 5,
        title: 'Top Tier Product',
        comment:
            'Fantastic design and performance. Easily one of my best purchases.',
    },
    {
        rating: 5,
        title: 'Great Buy!',
        comment:
            'Delivered quickly and exceeded expectations in both look and function.',
    },
    {
        rating: 5,
        title: 'Premium Quality',
        comment:
            'Every detail feels intentional and well-crafted. Totally satisfied.',
    },
    {
        rating: 5,
        title: 'Would Buy Again',
        comment:
            'Stylish, strong, and reliable. I’m definitely coming back for more.',
    },
]
